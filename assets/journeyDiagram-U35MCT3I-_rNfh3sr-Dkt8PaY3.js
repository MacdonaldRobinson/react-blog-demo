...
`,"getStyles"),Ft=Vt,Z=n(function(t,e){return gt(t,e)},"drawRect"),Lt=n(function(t,e){const a=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),l=t.append("g");l.append("circle").attr("cx",e.cx-15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),l.append("circle").attr("cx",e.cx+15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666");function s(y){const d=Q().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);y.append("path").attr("class","mouth").attr("d",d).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}n(s,"smile");function h(y){const d=Q().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);y.append("path").attr("class","mouth").attr("d",d).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}n(h,"sad");function c(y){y.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return n(c,"ambivalent"),e.score>3?s(l):e.score<3?h(l):c(l),a},"drawFace"),rt=n(function(t,e){const a=t.append("circle");return a.attr("cx",e.cx),a.attr("cy",e.cy),a.attr("class","actor-"+e.pos),a.attr("fill",e.fill),a.attr("stroke",e.stroke),a.attr("r",e.r),a.class!==void 0&&a.attr("class",a.class),e.title!==void 0&&a.append("title").text(e.title),a},"drawCircle"),ot=n(function(t,e){return ft(t,e)},"drawText"),Bt=n(function(t,e){function a(s,h,c,y,d){return s+","+h+" "+(s+c)+","+h+" "+(s+c)+","+(h+y-d)+" "+(s+c-d*1.2)+","+(h+y)+" "+s+","+(h+y)}n(a,"genPoints");const l=t.append("polygon");l.attr("points",a(e.x,e.y,50,20,7)),l.attr("class","labelBox"),e.y=e.y+e.labelMargin,e.x=e.x+.5*e.labelMargin,ot(t,e)},"drawLabel"),Ot=n(function(t,e,a){const l=t.append("g"),s=at();s.x=e.x,s.y=e.y,s.fill=e.fill,s.width=a.width*e.taskCount+a.diagramMarginX*(e.taskCount-1),s.height=a.height,s.class="journey-section section-type-"+e.num,s.rx=3,s.ry=3,Z(l,s),lt(a)(e.text,l,s.x,s.y,s.width,s.height,{class:"journey-section section-type-"+e.num},a,e.colour)},"drawSection"),it=-1,Rt=n(function(t,e,a){const l=e.x+a.width/2,s=t.append("g");it++;const h=300+5*30;s.append("line").attr("id","task"+it).attr("x1",l).attr("y1",e.y).attr("x2",l).attr("y2",h).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),Lt(s,{cx:l,cy:300+(5-e.score)*30,score:e.score});const c=at();c.x=e.x,c.y=e.y,c.fill=e.fill,c.width=a.width,c.height=a.height,c.class="task task-type-"+e.num,c.rx=3,c.ry=3,Z(s,c);let y=e.x+14;e.people.forEach(d=>{const x=e.actors[d].color,f={cx:y,cy:e.y,r:7,fill:x,stroke:"#000",title:d,pos:e.actors[d].position};rt(s,f),y+=10}),lt(a)(e.task,s,c.x,c.y,c.width,c.height,{class:"task"},a,e.colour)},"drawTask"),Dt=n(function(t,e){dt(t,e)},"drawBackgroundRect"),lt=function(){function t(s,h,c,y,d,x,f,g){const i=h.append("text").attr("x",c+d/2).attr("y",y+x/2+5).style("font-color",g).style("text-anchor","middle").text(s);l(i,f)}n(t,"byText");function e(s,h,c,y,d,x,f,g,i){const{taskFontSize:r,taskFontFamily:u}=g,p=s.split(/<br\s*\/?>/gi);for(let o=0;o<p.length;o++){const m=o*r-r*(p.length-1)/2,k=h.append("text").attr("x",c+d/2).attr("y",y).attr("fill",i).style("text-anchor","middle").style("font-size",r).style("font-family",u);k.append("tspan").attr("x",c+d/2).attr("dy",m).text(p[o]),k.attr("y",y+x/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),l(k,f)}}n(e,"byTspan");function a(s,h,c,y,d,x,f,g){const i=h.append("switch"),r=i.append("foreignObject").attr("x",c).attr("y",y).attr("width",d).attr("height",x).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");r.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(s),e(s,i,c,y,d,x,f,g),l(r,f)}n(a,"byFo");function l(s,h){for(const c in h)c in h&&s.attr(c,h[c])}return n(l,"_setTextAttrs"),function(s){return s.textPlacement==="fo"?a:s.textPlacement==="old"?t:e}}(),Nt=n(function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")},"initGraphics"),F={drawRect:Z,drawCircle:rt,drawSection:Ot,drawText:ot,drawLabel:Bt,drawTask:Rt,drawBackgroundRect:Dt,initGraphics:Nt},zt=n(function(t){Object.keys(t).forEach(function(e){R[e]=t[e]})},"setConf"),M={};function ct(t){const e=A().journey;let a=60;Object.keys(M).forEach(l=>{const s=M[l].color,h={cx:20,cy:a,r:7,fill:s,stroke:"#000",pos:M[l].position};F.drawCircle(t,h);const c={x:40,y:a+7,fill:"#666",text:l,textMargin:e.boxTextMargin|5};F.drawText(t,c),a+=20})}n(ct,"drawActorLegend");var R=A().journey,I=R.leftMargin,Yt=n(function(t,e,a,l){const s=A().journey,h=A().securityLevel;let c;h==="sandbox"&&(c=W("#i"+e));const y=h==="sandbox"?W(c.nodes()[0].contentDocument.body):W("body");$.init();const d=y.select("#"+e);F.initGraphics(d);const x=l.db.getTasks(),f=l.db.getDiagramTitle(),g=l.db.getActors();for(const m in M)delete M[m];let i=0;g.forEach(m=>{M[m]={color:s.actorColours[i%s.actorColours.length],position:i},i++}),ct(d),$.insert(0,0,I,Object.keys(M).length*50),Wt(d,x,0);const r=$.getBounds();f&&d.append("text").text(f).attr("x",I).attr("font-size","4ex").attr("font-weight","bold").attr("y",25);const u=r.stopy-r.starty+2*s.diagramMarginY,p=I+r.stopx+2*s.diagramMarginX;vt(d,u,p,s.useMaxWidth),d.append("line").attr("x1",I).attr("y1",s.height*4).attr("x2",p-I-4).attr("y2",s.height*4).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");const o=f?70:0;d.attr("viewBox",`${r.startx} -25 ${p} ${u+o}`),d.attr("preserveAspectRatio","xMinYMin meet"),d.attr("height",u+o+25)},"draw"),$={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:n(function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},"init"),updateVal:n(function(t,e,a,l){t[e]===void 0?t[e]=a:t[e]=l(a,t[e])},"updateVal"),updateBounds:n(function(t,e,a,l){const s=A().journey,h=this;let c=0;function y(d){return n(function(x){c++;const f=h.sequenceItems.length-c+1;h.updateVal(x,"starty",e-f*s.boxMargin,Math.min),h.updateVal(x,"stopy",l+f*s.boxMargin,Math.max),h.updateVal($.data,"startx",t-f*s.boxMargin,Math.min),h.updateVal($.data,"stopx",a+f*s.boxMargin,Math.max),d!=="activation"&&(h.updateVal(x,"startx",t-f*s.boxMargin,Math.min),h.updateVal(x,"stopx",a+f*s.boxMargin,Math.max),h.updateVal($.data,"starty",e-f*s.boxMargin,Math.min),h.updateVal($.data,"stopy",l+f*s.boxMargin,Math.max))},"updateItemBounds")}n(y,"updateFn"),this.sequenceItems.forEach(y())},"updateBounds"),insert:n(function(t,e,a,l){const s=Math.min(t,a),h=Math.max(t,a),c=Math.min(e,l),y=Math.max(e,l);this.updateVal($.data,"startx",s,Math.min),this.updateVal($.data,"starty",c,Math.min),this.updateVal($.data,"stopx",h,Math.max),this.updateVal($.data,"stopy",y,Math.max),this.updateBounds(s,c,h,y)},"insert"),bumpVerticalPos:n(function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},"bumpVerticalPos"),getVerticalPos:n(function(){return this.verticalPos},"getVerticalPos"),getBounds:n(function(){return this.data},"getBounds")},X=R.sectionFills,st=R.sectionColours,Wt=n(function(t,e,a){const l=A().journey;let s="";const h=l.height*2+l.diagramMarginY,c=a+h;let y=0,d="#CCC",x="black",f=0;for(const[g,i]of e.entries()){if(s!==i.section){d=X[y%X.length],f=y%X.length,x=st[y%st.length];let u=0;const p=i.section;for(let m=g;m<e.length&&e[m].section==p;m++)u=u+1;const o={x:g*l.taskMargin+g*l.width+I,y:50,text:i.section,fill:d,num:f,colour:x,taskCount:u};F.drawSection(t,o,l),s=i.section,y++}const r=i.people.reduce((u,p)=>(M[p]&&(u[p]=M[p]),u),{});i.x=g*l.taskMargin+g*l.width+I,i.y=c,i.width=l.diagramMarginX,i.height=l.diagramMarginY,i.colour=x,i.fill=d,i.num=f,i.actors=r,F.drawTask(t,i,l),$.insert(i.x,i.y,i.x+i.width+l.taskMargin,300+5*30)}},"drawTasks"),nt={setConf:zt,draw:Yt},Gt={parser:Tt,db:et,renderer:nt,styles:Ft,init:n(t=>{nt.setConf(t.journey),et.clear()},"init")};export{Gt as diagram};
